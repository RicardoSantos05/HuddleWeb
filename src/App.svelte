	...
	function startGame() {
		...
		const penguinWidth = window.innerWidth * 0.08; // Ex: 8vw
		const penguinHeight = penguinWidth;
	...
	<div class="scaled-wrapper">
		<div class="fixed-resolution-wrapper">
			<!-- imagens do jogo -->
			<img src="penguin.png" alt="" class="penguin" style="left: {x}px; top: {y}px;" />
			<img src="fish.png" alt="" class="fish" style="left: {fishX}px; top: {fishY}px;" />
			{#each seals as seal}
				<img src="seal.png" alt="" class="seal" style="left: {seal.x}px; top: {seal.y}px;" />
			{/each}
		</div>
	</div>
